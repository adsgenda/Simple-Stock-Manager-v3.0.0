    ...
    <div class="max-w-7xl mx-auto py-10 sm:px-6 lg:px-8">
      <FormSection @submitted="submit" autocomplete="off">
        ...
        <template #form>
          ...
          <div class="col-span-6 sm:col-span-3">
            <TextInput v-model="form.cf1" id="cf1" :error="form.errors.cf1" :label="t($settings?.customer_cf1 || 'Custom Field 1')" />
          </div>
          <div class="col-span-6 sm:col-span-3">
            <TextInput v-model="form.cf2" id="cf2" :error="form.errors.cf2" :label="t($settings?.customer_cf2 || 'Custom Field 2')" />
          </div>
        </template>
