    ...
    <template #content>
      ...
      <div v-if="twoFactorEnabled">
        <div v-if="qrCode">
          ...
          <div class="mt-4 p-3 rounded-md bg-white inline-flex items-start justify-center">
            <div v-html="qrCode" />
          </div>
      ...
      <div class="mt-5">
        <div v-if="!twoFactorEnabled">
          <JetConfirmsPassword @confirmed="enableTwoFactorAuthentication">
            <JetButton type="button" :class="{ 'opacity-25': enabling }" :disabled="enabling"> {{ t('Enable') }} </JetButton>
          </JetConfirmsPassword>
        </div>
