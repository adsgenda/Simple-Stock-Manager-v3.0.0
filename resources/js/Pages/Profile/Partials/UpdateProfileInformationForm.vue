...
<template>
  <JetFormSection @submitted="updateProfileInformation">
    ...
    <template #actions>
      <JetActionMessage :on="form.recentlySuccessful" class="mr-3"> {{ t('Saved.') }} </JetActionMessage>

      <JetButton :class="{ 'opacity-25': form.processing }" :disabled="form.processing"> {{ t('Save') }} </JetButton>
    </template>
  </JetFormSection>
</template>
