<template>
  <div class="col-span-6 sm:col-span-4">
    ...
    <div class="relative mt-1 mb-2">
      <label :for="id" name="chevron-down" class="cursor-pointer absolute top-0 right-0 border border-transparent p-3 text-gray-500">
      ...
      <input
        ...
        class="w-full block text-base py-2 pl-4 placeholder-gray-400 border border-gray-300 focus:outline-none focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50 rounded-md shadow-sm"
      />
