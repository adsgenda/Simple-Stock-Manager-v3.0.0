...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    const deleteRow = (id, force = false) => {
      router.delete(T("customers.destroy" + (force ? ".permanently" : ""), id));
    };
    const restoreRow = (id) => {
      router.put(T("customers.restore", id));
    };
    const closeModal = () => {
    ...
    const deleteSelected = (force) => {
      form.delete(T("customers.destroy.many"), {
        onSuccess: () => {
          form.reset();
        },
        onFinish: () => {
    ...
    const searchNow = () => {
      ...
      }).get(T("customers.index"), { preserveState: true });
    };
    const resetSearch = () => {
      search.search = "";
      search.trashed = null;
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          ...
          if (_push2) {
            ...
            if (props.customers && props.customers.data && props.customers.data.length) {
              ...
              _push2(`<table class="min-w-full table-fixed divide-y divide-gray-300 dark:divide-gray-700"${_scopeId}><thead class="bg-gray-50 dark:bg-black/50"${_scopeId}><tr${_scopeId}><th scope="col" class="relative w-12 px-6 sm:w-16 sm:px-8"${_scopeId}><input type="checkbox"${ssrRenderAttr("indeterminate", indeterminate.value)}${ssrIncludeBooleanAttr(indeterminate.value || unref(form).selection.length === props.customers.data.length) ? " checked" : ""} class="absolute left-4 top-1/2 -mt-2 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 sm:left-6 dark:bg-gray-700 dark:border-gray-700"${_scopeId}></th><th scope="col" class="px-3 py-3.5 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)("Name"))}</th><th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)("Company"))}</th><th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)("Email"))}</th><th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)("Phone"))}</th><th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)(((_a = _ctx.$settings) == null ? void 0 : _a.customer_cf1) || "Custom Field 1"))}</th><th scope="col" class="py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"${_scopeId}>${ssrInterpolate(unref(t)(((_b = _ctx.$settings) == null ? void 0 : _b.customer_cf2) || "Custom Field 2"))}</th><th scope="col" class="relative py-3.5 pl-3 pr-4 sm:pr-6"${_scopeId}><span class="sr-only"${_scopeId}>${ssrInterpolate(unref(t)("Actions"))}</span></th></tr></thead><tbody class="divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900"${_scopeId}><!--[-->`);
              ssrRenderList(props.customers.data, (customer) => {
                _push2(`<tr class="${ssrRenderClass([
                  unref(form).selection.includes(customer.id) && "bg-gray-50 dark:bg-gray-800/50",
                  customer.deleted_at && "bg-red-100 dark:bg-red-900"
                ])}"${_scopeId}><td class="relative w-12 px-6 sm:w-16 sm:px-8"${_scopeId}>`);
                if (unref(form).selection.includes(customer.id)) {
                  _push2(`<div class="absolute inset-y-0 left-0 w-0.5 bg-blue-600"${_scopeId}></div>`);
                } else {
                  _push2(`<!---->`);
                }
                _push2(`<input type="checkbox"${ssrRenderAttr("value", customer.id)}${ssrIncludeBooleanAttr(Array.isArray(unref(form).selection) ? ssrLooseContain(unref(form).selection, customer.id) : unref(form).selection) ? " checked" : ""} class="absolute left-4 top-1/2 -mt-2 h-4 w-4 rounded border-gray-300 text-blue-600 focus:ring-blue-500 sm:left-6 dark:bg-gray-700 dark:border-gray-700"${_scopeId}></td><td class="whitespace-nowrap px-3 py-4 text-sm font-medium"${_scopeId}>${ssrInterpolate(customer.name)}</td><td class="whitespace-nowrap px-3 py-4 text-sm"${_scopeId}>${ssrInterpolate(customer.company)}</td><td class="whitespace-nowrap px-3 py-4 text-sm"${_scopeId}>${ssrInterpolate(customer.email)}</td><td class="whitespace-nowrap px-3 py-4 text-sm"${_scopeId}>${ssrInterpolate(customer.phone)}</td><td class="whitespace-nowrap px-3 py-4 text-sm"${_scopeId}>${ssrInterpolate(customer.cf1)}</td><td class="whitespace-nowrap px-3 py-4 text-sm"${_scopeId}>${ssrInterpolate(customer.cf2)}</td><td class="whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 w-20"${_scopeId}>`);
                _push2(ssrRenderComponent(_sfc_main$7, {
                  ...
                  editStr: unref(T)("customers.edit", customer.id)
                  ...
                  createVNode("div", { class: "bg-white dark:bg-gray-900 shadow sm:rounded-lg" }, [
                    createVNode("div", { class: "sm:rounded-lg" }, [
                      ...
                      createVNode("div", { class: "bg-gray-50 dark:bg-black/50 border-b dark:border-gray-700 sm:rounded-b-lg" }, [
                        props.customers && props.customers.data && props.customers.data.length ? (openBlock(), createBlock("div", { key: 0 }, [
                                ...
                                createVNode("div", { class: "relative overflow-hidden ring-1 ring-black ring-opacity-5" }, [
                                  ...
                                  createVNode("table", { class: "min-w-full table-fixed divide-y divide-gray-300 dark:divide-gray-700" }, [
                                      ...
                                      createVNode("tr", null, [
                                        createVNode("th", {
                                          ...
                                          createVNode("input", {
                                            ...
                                            checked: indeterminate.value || unref(form).selection.length === props.customers.data.length,
                                            onChange: ($event) => unref(form).selection = $event.target.checked ? props.customers.data.map((p) => p.id) : [],
                                        ...
                                        createVNode("th", {
                                          scope: "col",
                                          class: "py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"
                                        }, toDisplayString(unref(t)(((_c = _ctx.$settings) == null ? void 0 : _c.customer_cf1) || "Custom Field 1")), 1),
                                        createVNode("th", {
                                          scope: "col",
                                          class: "py-3.5 px-3 text-left text-sm font-semibold text-gray-900 dark:text-gray-100"
                                        }, toDisplayString(unref(t)(((_d = _ctx.$settings) == null ? void 0 : _d.customer_cf2) || "Custom Field 2")), 1),
                                        createVNode("th", {
                                          scope: "col",
                                    ...
                                    createVNode("tbody", { class: "divide-y divide-gray-200 dark:divide-gray-700 bg-white dark:bg-gray-900" }, [
                                      (openBlock(true), createBlock(Fragment, null, renderList(props.customers.data, (customer) => {
                                        return openBlock(), createBlock("tr", {
                                          ...
                                          createVNode("td", { class: "relative w-12 px-6 sm:w-16 sm:px-8" }, [
                                            unref(form).selection.includes(customer.id) ? (openBlock(), createBlock("div", {
                                              key: 0,
                                          ...
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm font-medium" }, toDisplayString(customer.name), 1),
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm" }, toDisplayString(customer.company), 1),
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm" }, toDisplayString(customer.email), 1),
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm" }, toDisplayString(customer.phone), 1),
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm" }, toDisplayString(customer.cf1), 1),
                                          createVNode("td", { class: "whitespace-nowrap px-3 py-4 text-sm" }, toDisplayString(customer.cf2), 1),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Customer/List.vue");
