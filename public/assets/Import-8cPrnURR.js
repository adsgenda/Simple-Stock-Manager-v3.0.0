  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: unref(t)("Import {x}", { x: unref(t)("Items") })
      }, _attrs), {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, { onSubmitted: submit }, {
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("Import {x}", { x: unref(t)("Items") }))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(unref(t)("Import {x}", { x: unref(t)("Items") })), 1)
                  ];
                }
              }),
              description: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    away: "",
                    href: _ctx.route("items.export")
                  }, {
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(t)("Export Items"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(t)("Export Items")), 1)
                        ];
                      }
                    }),
                    _: 1
              ...
              form: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(`<input type="file" class="sr-only" id="file-upload" name="file-upload" accept=".xls,.xlsx,application/vnd.ms-excel"${_scopeId2}></label><p class="pl-1"${_scopeId2}>${ssrInterpolate(unref(t)("or drag and drop"))}</p></div><div class="text-xs"${_scopeId2}><div${_scopeId2}>${ssrInterpolate(unref(t)("Excel file should have name, code, symbology, category_code, quantity, unit, alert_quantity and photo columns."))}</div><div${_scopeId2}>${ssrInterpolate(unref(t)("The name, code, symbology and category_code are required."))}</div><div${_scopeId2}>${ssrInterpolate(unref(t)("Symbology can be one of CODE128, CODE39, EAN8, EAN13 or UPC."))}</div></div>`);
                  if (selected.value) {
                      ...
                      createVNode("div", {
                        ...
                        createVNode("div", { class: "space-y-1 text-center" }, [
                          ...
                          createVNode("div", { class: "text-xs" }, [
                            createVNode("div", null, toDisplayString(unref(t)("Excel file should have name, code, symbology, category_code, quantity, unit, alert_quantity and photo columns.")), 1),
                            createVNode("div", null, toDisplayString(unref(t)("The name, code, symbology and category_code are required.")), 1),
                            createVNode("div", null, toDisplayString(unref(t)("Symbology can be one of CODE128, CODE39, EAN8, EAN13 or UPC.")), 1)
                          ]),
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Item/Import.vue");
