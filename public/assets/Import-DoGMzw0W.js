  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: unref(t)("Import {x}", { x: unref(t)("Suppliers") })
      }, _attrs), {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, { onSubmitted: submit }, {
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(unref(t)("Import {x}", { x: unref(t)("Suppliers") }))}`);
                } else {
                  return [
              ...
              description: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$3, {
                    ...
                    default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                      if (_push4) {
                        _push4(`${ssrInterpolate(unref(t)("Export Suppliers"))}`);
                      } else {
                        return [
                          createTextVNode(toDisplayString(unref(t)("Export Suppliers")), 1)
                        ];
                      }
                    }),
                    _: 1
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Supplier/Import.vue");
