  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        title: props.edit ? unref(t)("Edit Customer") : unref(t)("Add New Customer")
      }, _attrs), {
          ...
          if (_push2) {
            ...
            _push2(ssrRenderComponent(_sfc_main$2, {
              ...
              title: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`${ssrInterpolate(props.edit ? unref(t)("Edit Customer") : unref(t)("Add New Customer"))}`);
                } else {
                  return [
                    createTextVNode(toDisplayString(props.edit ? unref(t)("Edit Customer") : unref(t)("Add New Customer")), 1)
                  ];
                }
              }),
              ...
              form: withCtx((_2, _push3, _parent3, _scopeId2) => {
                ...
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    ...
                    label: unref(t)(((_a = _ctx.$settings) == null ? void 0 : _a.customer_cf1) || "Custom Field 1")
                  }, null, _parent3, _scopeId2));
                  _push3(`</div><div class="col-span-6 sm:col-span-3"${_scopeId2}>`);
                  _push3(ssrRenderComponent(_sfc_main$4, {
                    ...
                    label: unref(t)(((_b = _ctx.$settings) == null ? void 0 : _b.customer_cf2) || "Custom Field 2")
                  }, null, _parent3, _scopeId2));
                  _push3(`</div>`);
                } else {
                  return [
                    ...
                    createVNode("div", { class: "col-span-6 sm:col-span-3" }, [
                      createVNode(_sfc_main$4, {
                        ...
                        id: "cf1",
                        error: unref(form).errors.cf1,
                        label: unref(t)(((_c = _ctx.$settings) == null ? void 0 : _c.customer_cf1) || "Custom Field 1")
                      }, null, 8, ["modelValue", "onUpdate:modelValue", "error", "label"])
                    ]),
                    createVNode("div", { class: "col-span-6 sm:col-span-3" }, [
                      createVNode(_sfc_main$4, {
                        ...
                        id: "cf2",
                        error: unref(form).errors.cf2,
                        label: unref(t)(((_d = _ctx.$settings) == null ? void 0 : _d.customer_cf2) || "Custom Field 2")
                      }, null, 8, ["modelValue", "onUpdate:modelValue", "error", "label"])
                    ])
                  ];
                }
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("resources/js/Pages/Customer/Form.vue");
